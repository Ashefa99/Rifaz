...
def algorithm():
    ...
    for x in path :
        if ".csv" in x :
            file_path = os.path.abspath('./data/'+ x)
            print(file_path)
            ...
            with open(file_path, "r") as hashtag_file :
                ...
                for check_hash in hashtag_file :
                    ...
                    if check in check_hash :
                        ...
                        compare_file = open("./data/compare_hash", "a")
